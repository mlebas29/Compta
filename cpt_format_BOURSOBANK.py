...
# -*- coding: utf-8 -*-
"""
cpt_format_BOURSOBANK.py - Convertit les CSV BoursoBank en format standardisé
...
Usage:
  ./cpt_format_BOURSOBANK.py <fichier.csv>
"""
...
def process_positions(input_files):
    ...
    """
    # Mapping des noms de titres (corrige les variations de labellisation banque) — config_accounts.json privé
    # Schéma : "BOURSOBANK": { "titre_renames": { "<label banque>": "<nom canonique>", ... } }
    TITRE_MAPPING = _bb_config.get('titre_renames', {})
