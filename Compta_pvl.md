...
**Cas d'un compte métaux adossé à une carte de paiement.** Compte adossé à des pièces de monnaie en or. Naturellement classé *métaux*. Le critère « performance recherchée » seul n'est pas tranchant (il y a des opérations diverses : achats/ventes de pièces, frais, paiements carte). C'est la **dépensabilité** (la carte de paiement) qui justifie pleinement le modèle EUR.
