#!/usr/bin/env python3
"""
cpt_fetch_NATIXIS.py - Récupération automatique des données PEE (Plan d'Épargne Entreprise)
...
Usage:
  ./cpt_fetch_NATIXIS.py           # Mode normal
  ./cpt_fetch_NATIXIS.py -v        # Mode verbeux

Fichiers générés:
  - dropbox/NATIXIS/Mon épargne en détail - Natixis Interépargne.pdf
  - dropbox/NATIXIS/Historique et suivi de mes opérations - Natixis Interépargne.pdf
"""
