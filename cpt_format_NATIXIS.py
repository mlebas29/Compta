...
Usage:
  ./cpt_format_NATIXIS.py <fichier.csv|.pdf>
  cat fichier.csv | ./cpt_format_NATIXIS.py
"""
...
from inc_format import process_files, lines_to_tuples, log_csv_debug as _log_csv_debug, get_file_date, site_name_from_file, base_dir, lazy
